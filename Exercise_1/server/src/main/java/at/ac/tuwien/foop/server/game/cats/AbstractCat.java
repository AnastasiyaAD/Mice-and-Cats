...
public abstract class AbstractCat implements IServerCatState {
    protected double[] position;
    protected final Configuration configuration;

    public AbstractCat(Configuration configuration, double[] position) {
    ...
    protected void moveTowards(double[] targetPos) {
        ...
        this.position = computeMoveToMouse(targetPos, this.position, speedPerTick);
    }

...
extern void F983_7509(EIF_REFERENCE);
extern void F983_7510(EIF_REFERENCE);
extern void F983_7511(EIF_REFERENCE);
extern void F983_7512(EIF_REFERENCE);
extern void F983_7502(EIF_REFERENCE);
...
EIF_TYPED_VALUE F983_7500 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13458);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13458);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_7501 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13459);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13459);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
/* {MOUSE}.move_up */
void F983_7509 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13463);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13463);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5240, dtype));
...
/* {MOUSE}.move_down */
void F983_7510 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13464);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13464);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5240, dtype));
...
/* {MOUSE}.move_left */
void F983_7511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13465);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13465);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5238, dtype));
	if ((EIF_BOOLEAN) (ti4_1 > ((EIF_INTEGER_32) 0L))) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5238, dtype));
		ui4_1 = (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L));
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5239, dtype))(Current, ui4_1x);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
/* {MOUSE}.move_right */
void F983_7512 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13466);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13466);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5238, dtype));
...
/* {MOUSE}.make */
void F983_7502 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13457);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;

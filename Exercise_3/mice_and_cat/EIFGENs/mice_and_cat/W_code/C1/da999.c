...
extern EIF_TYPED_VALUE F999_7634(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_7635(EIF_REFERENCE);
extern EIF_TYPED_VALUE F999_7636(EIF_REFERENCE);
...
EIF_TYPED_VALUE F999_7634 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F999_7635 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F999_7636 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 13565);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 13565);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5370, "fractional_second", tr1));

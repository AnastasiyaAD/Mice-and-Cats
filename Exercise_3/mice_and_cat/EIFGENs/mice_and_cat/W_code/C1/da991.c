...
extern EIF_TYPED_VALUE F991_7561(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7562(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7563(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7564(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7565(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7566(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7567(EIF_REFERENCE);
extern EIF_TYPED_VALUE F991_7568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F991_7561 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F991_7561,13510,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F991_7562)
EIF_TYPED_VALUE F991_7562 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13510);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {320,0xFF01,237,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(2315, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
RTOID (F991_7563)
EIF_TYPED_VALUE F991_7563 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13511);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000144, 0,0); /* Result */
...
RTOID (F991_7564)
EIF_TYPED_VALUE F991_7564 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13504);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13504);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000144, 0,0); /* Result */
...
RTOID (F991_7565)
EIF_TYPED_VALUE F991_7565 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 13505);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 13505);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000144, 0,0); /* Result */
...
EIF_TYPED_VALUE F991_7566 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F991_7566,13507,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F991_7567 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F991_7567,13508,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F991_7568 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F991_7568,13509,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit991 (void)
{
	GTCX
	RTOTS (7561,F991_7561)
	RTOTS (7562,F991_7562)
	RTOTS (7563,F991_7563)
	RTOTS (7564,F991_7564)
	RTOTS (7565,F991_7565)
	RTOTS (7566,F991_7566)
	RTOTS (7567,F991_7567)
	RTOTS (7568,F991_7568)
}
